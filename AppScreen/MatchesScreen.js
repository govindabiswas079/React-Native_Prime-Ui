...
import InPay from '../AppComponent/MatchesComponent/InPay';
import LiveNow from '../AppComponent/MatchesComponent/LiveNow';
import InternationalMatches from '../AppComponent/MatchesComponent/InternationalMatches';
    ...
    <>
      ...
      <View style={{ flex: 1, backgroundColor: '#202342', paddingHorizontal: 15, paddingTop: 20 }}>
        ...
        <View style={{ paddingTop: 10, paddingBottom: 10 }}>
          <Text style={{ color: '#ffffff', fontSize: 20, fontFamily: 'Gilroy-Medium', fontWeight: '700' }}>Bet with PrimeSport</Text>
        </View>
