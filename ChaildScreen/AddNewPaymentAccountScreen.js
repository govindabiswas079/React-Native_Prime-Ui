...
import PaymentCard from '../ChaildComponent/AddNewPaymentAccount/Component/PaymentCard';
import AddAccount from '../ChaildComponent/AddNewPaymentAccount/Component/AddAccount';

const AddNewPaymentAccountScreen = ({ navigation }) => {
  return (
    <>
...
export default AddNewPaymentAccountScreen